...
import { AlertComponent } from './run/shared/alert/alert.component';
...
import { PlaceholderDirective } from './run/shared/placeholder/placeholder.directive';
...
export class DynCmpFinishedModule {
}
